...
recify = do
  ...
  scottyOpts scottyOptions $ do
    ...
    get "/dashboard" $ do
      ...
      log "Got access token data from cookies"
      ...
      case maybeMarshalledRecentlyPlayed of
        Right marshalledRecentlyPlayed -> do
          ...
          log "Fetched and marshalled artists"
